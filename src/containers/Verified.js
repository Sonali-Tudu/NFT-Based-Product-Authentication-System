            ...
            <div className="section-type landing-page">
                <div className="landing-content" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '100vh' }}>
                    <div className="headings">
                        <span className='ml-10 mb-3 text-[30px] lg:text-[60px] font-secondary font-semibold leading-[1]lg:text-[50px] text-blue-500'>Verified status✅ </span>
                    ...
                    <motion.div
                        ...
                        className='ml-10 mb-3 text-[30px] lg:text-[60px] font-secondary font-semibold uppercase leading-[1]lg:text-[50px] text-black'
                    >
